...
def enable_backend(
    ...
    *,
    ...
    """Work with both the current optional-fusion API and always-fused API."""
    ...
    # Current code still exposes fuse_qkv. Force it on.
    # If that option is removed later, this remains compatible.
